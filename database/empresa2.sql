...
--
-- Host: localhost:3306
-- Tempo de geração: 15/05/2024 às 12:15
-- Versão do servidor: 8.0.36-2ubuntu3
-- Versão do PHP: 8.3.7

-- OBS.: MESMO BANCO DE DADOS, SÓ COM ALGUMAS INFORMAÇÕES NOVAS E RODANDO NA VERSÃO MAIS RECENTE DO PHP (8.3.7)
...
(17, 'Pedro', '2002-08-24', 'UX Designer');
...
(11, 17, '2024-05-14', '13:00:00', '15:30:00', '16:30:00', '19:00:00', '05:00:00');
...
--
ALTER TABLE `registro_horas`
  MODIFY `id_ponto` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;
